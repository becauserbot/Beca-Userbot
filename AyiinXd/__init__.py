...
ALIVE_TEKS_CUSTOM = os.environ.get(
    "ALIVE_TEKS_CUSTOM",
    "𝙷𝙴𝚈, 𝚂𝙰𝚈𝙰 𝙿𝙴𝙽𝙶𝙶𝚄𝙽𝙰 ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", " ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ")
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**✨ ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ 𝙸𝙽𝙻𝙸𝙽𝙴 𝙼𝙴𝙽𝚄 ✨**\n\n⍟ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n⍟ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n⍟ **ᴏᴡɴᴇʀ** {user.first_name}\n⍟ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
                await event.edit(
                    text,
                    file=logoyins,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ",
                    ...
                    buttons=[
                        [
                            ...
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/becaubot/Beca-Userbot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="String",
                    description="String ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ",
                    url="https://t.me/kazusupportgrp",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                ...
                result = builder.article(
                    title="ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ",
                    description="ʙᴇᴄᴀ ᴜsᴇʀʙᴏᴛ | Telethon",
                    url="https://t.me/kazusupportgrp",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                    ...
                    buttons=[
                        [
                            ...
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/beca/Beca-Userbot"),
                        ],
                    ],
                    link_preview=False,
                )
